    ...
    return(
        ...
        <div className="col-9 overflow-auto altura">
            <div className=" d-flex justify-content-center align-content-center m-5 border-bottom">
                <h1 className="pb-3 link-secondary font">Suas Compras</h1>
            </div>
            <div className="col-12 d-flex justify-content-center">
                <div className="col-11">
                    <div className="d-flex border-bottom pb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="link-secondary me-3 bi bi-emoji-frown" viewBox="0 0 16 16">
